...
SmartObject.prototype.acquire = function (oid, iid, rid) {
  if (arguments.length === 1) { return this.findObject(oid) } else if (arguments.length === 2) { return this.findObjectInstance(oid, iid) } else if (arguments.length === 3) { return this.get(oid, iid, rid) } else { return undefined }
}
